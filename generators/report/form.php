        ...
        $("#generator-modelclass").on("change", function() {
            ...
            if (o.closest("div").not(".has-error") && o.val() !== '') {
                var modelClass = o.val(),
                    ...
                    searchModelClass = 'backend\\\\modules\\\\statistics\\\\models\\\\' + modelClassName + 'Search',
                    controllerClass = 'backend\\\\modules\\\\statistics\\\\controllers\\\\' + modelClassName + 'Controller',
                    viewPath = '@backend/modules/statistics/views/' + modelClassName.replace(/([A-Z])/g, '-$1').toLowerCase().replace(/^\-/, ''),
